...
Specify first rhpam env to manage; default = 1
...
.. quay.io/btison/rhpam72-kieserver-openshift-gpte:1.1 
.. quay.io/btison/rhpam72-businesscentral-openshift-gpte:1.1
