...
. Authenticate into the `kieRealm` and capture the client secret of the `kie-server` client
+
...
client_secret=252793ed-7118-4ca8-8dab-5622fa97d892
-----
...
. Using the OAuth2 token, invoke the kie-server
+
-----
